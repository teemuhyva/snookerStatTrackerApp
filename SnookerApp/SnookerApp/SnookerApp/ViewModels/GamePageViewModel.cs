...
namespace SnookerApp.ViewModels
{
    public class GamePageViewModel : INotifyPropertyChanged
    {
        ...
        public GamePageViewModel()
        {
            ...
            GoToStats = new Command(async () => await GoToStatsPage(gameStatistics));
        }
        ...
        void OnePoint()
        {
            if (currentAmountRedPotted < 15 || totalPointsInGame < 147)
            {
                if (player1Turn)
                {
                    ...
                    potsSuccessPlayer1++;
                    totalTriesPlayer1++;
                    new GameStatistics(potsSuccessPlayer1, potsSuccessPlayer1);
        ...
        public async Task GoToStatsPage(GameStatistics gameStatistics)
        {
            gameStatistics.PotsSuccessPlayer1 = potsSuccessPlayer1;
            gameStatistics.TotalTriesPlayer1 = totalTriesPlayer1;
